...
object MovieList {
    ...
    val list: List<Media> by lazy {
        setupMovies()
    }
    private var count: Long = 0

    private fun setupMovies(): List<Media> {
        val title = arrayOf(
        ...
        val videoUrl = arrayOf(
            ...
            "http://127.0.0.1:11470/31fe340c5f610b3a123edb3ffe7ec1e28bf6b618/rick.and.morty.s05e04.1080p.webrip.x264-cakes.mkv",
        ...
        val bgImageUrl = arrayOf(
            ...
            "https://image.tmdb.org/t/p/original/xxlteGxXhpgnoMF7SvdYwHvljnB.jpg",
